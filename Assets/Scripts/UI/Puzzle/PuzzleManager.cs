...
public class PuzzleManager : MonoBehaviour //
{
    ...
    [Header("효과음 설정")]
    [Tooltip("퍼즐 완성 시 재생할 효과음 (AudioClip)")]
    public AudioClip completionSound; // 1. 인스펙터에서 할당할 효과음 파일
    ...
    // [요구 사항 4] 효과음 재생 로직을 이곳에 추가
    /// <summary>
    /// 알림 패널을 2초간 켰다가 끄는 코루틴입니다. (효과음 재생 포함)
    /// </summary>
